    ...
    <div className={style["stats-panel"]}>
      <div className={style["social-media-links"]}>
        <Link className={style['social-media-icon']} to={`https://www.facebook.com/${encodeURIComponent(socialMediaLinks.facebook_id)}`}>
          <img alt="facebook icon" loading="lazy" src="https://www.themoviedb.org/assets/2/v4/glyphicons/social/facebook-2c5718e4ece8eb3a3cc49ae97000e541c0aad50869b419b5aa579693bc0ad059.svg" />
        </Link>
        <Link className={`${style['twitter-icon']} ${style['social-media-icon']}`} to={`https://www.twitter.com/${encodeURIComponent(socialMediaLinks.twitter_id)}`}>
          <img alt="twitter icon" loading="lazy" src="https://www.themoviedb.org/assets/2/v4/glyphicons/social/twitter-a6ff8c172b8e086f4a64578cee0a16676c1a067b47a1b1b186d58795d241a852.svg" />
        </Link>
        <Link className={`${style['instagram-icon']} ${style['social-media-icon']}`} to={`https://www.instagram.com/${encodeURIComponent(socialMediaLinks.instagram_id)}`}>
          <img alt="instagram icon" loading="lazy" src="https://www.themoviedb.org/assets/2/v4/glyphicons/social/instagram-74e6299c864adc384258da3b3a8eb09282b7ccda4dd1dfa9a4158ba2ea8583b9.svg" />
        </Link>
        <div className={style.divider} />
        <Link className={`${style['homepage-icon']} ${style['social-media-icon']}`} to={homepage}>
          <img alt="link icon" loading="lazy" src="https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-351-link-5f643a86c2515cb06ea08ebc798941824f76bbcea4ed571222a81f271b30c7f3.svg" />
        </Link>
      </div>
